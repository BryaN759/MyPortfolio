                ...
                <div className={toggleState === 1 ? "qualification__content qualification__content-active"
                    ...
                    <div className="qualification__data">
                        <div>
                            ...
                            <span className="qualification__subtitle">Mohammadpur Preparatory</span>
                    ...
                    <div className="qualification__data">
                        ...
                        <div>
                            ...
                            <span className="qualification__subtitle">St. Joseph Higher Secondary School</span>
                            <div className="qualification__calendar">
                                <HiOutlineCalendar className="qualification__calendar-icon" />
                                2017-2019
                            </div>
                    ...
                    <div className="qualification__data">
                        <div>
                            <h3 className="qualification__title">BSc. in Computer Science and Enginnering</h3>
